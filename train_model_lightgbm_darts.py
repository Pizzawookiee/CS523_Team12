...
with open('test_data_target.pkl', 'rb') as file:
    test_data_target = pickle.load(file)
...
def main():
    ...
    def test(model_lgbm):
        ...
        pred = model_lgbm.predict(n = 12, series = test_data_target, past_covariates = test_data_past_covariates, future_covariates = test_data_future_covariates, verbose=True)
