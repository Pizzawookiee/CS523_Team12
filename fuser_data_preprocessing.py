...
#only use actual_arrival_time, is_arrival
#figure out why lots of times are being dropped
...
#save as file
result.to_parquet(arrival_airport + '_data_train_v2.parquet', engine='fastparquet', compression='brotli')
