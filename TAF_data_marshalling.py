...
def process_single_dataset(filename):
    ...
    write('TAF_test_ammend' + filename + '.parquet', ammend_df, compression='brotli', write_index=False)
    write('TAF_test_correct' + filename + '.parquet', correct_df, compression='brotli', write_index=False)
    write('TAF_test_original' + filename + '.parquet', original_df, compression='brotli', write_index=False)
